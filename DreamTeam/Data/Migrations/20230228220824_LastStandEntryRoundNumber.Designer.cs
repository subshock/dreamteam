...
namespace DreamTeam.Data.Migrations
{
    ...
    [Migration("20230228220824_LastStandEntryRoundNumber")]
    partial class LastStandEntryRoundNumber
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DreamTeam.Models.LastStand.Competition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<DateTimeOffset>("RegistrationEnds")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.ToTable("Competition", "LastStand");
                });

            modelBuilder.Entity("DreamTeam.Models.LastStand.Entry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Entry", "LastStand");
                });

            modelBuilder.Entity("DreamTeam.Models.LastStand.EntryRound", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EntryRound", "LastStand");
                });

            modelBuilder.Entity("DreamTeam.Models.LastStand.Round", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DreamTeam.Models.LastStand.Entry", b =>
                {
                    b.HasOne("DreamTeam.Models.LastStand.Competition", "Competition")
                        .WithMany()
            ...
            modelBuilder.Entity("DreamTeam.Models.LastStand.EntryRound", b =>
                {
                    b.HasOne("DreamTeam.Models.LastStand.Entry", "Entry")
                        .WithMany()
